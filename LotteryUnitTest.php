...
class LotteryUnitTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function getConfigurationAndExpectedResult()
    {
        return [
            ...
            ['y0229', '10:00:00', '2014-02-28 09:00:00', '2016-02-29 10:00:00'],//29th february (leap years)
            ['y0229', '10:00:00', '2016-02-28 09:00:00', '2016-02-29 10:00:00'],//29th february (leap years)
    ...
    public function getConfigurationAndExpectedResultForLast()
    {
        return [
            ...
            ['y0229', '10:00:00', '2014-03-01 11:00:00', '2012-02-29 10:00:00'],
            ['y0229', '10:00:00', '2016-03-01 11:00:00', '2016-02-29 10:00:00'],
